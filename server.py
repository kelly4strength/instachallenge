...
#why do I have to use 3 separate flashes?

    flash("Hi You chose hashtag %s" % hashtag)
    flash("Hi You chose start date %s" % startDate) 
    flash("Hi You chose end date %s" % endDate)
